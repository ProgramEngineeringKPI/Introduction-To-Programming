...
В цій роботі є додаткова умова на використання мов програмування: небажано використовувати мови, в яких немає низькорівневих масивів, наприклад python або js. Незалежно від обраної мови, майте на увазі, що використання будь-яких методів/функцій масивів крім доступу до елементів за індексом забороняється. Якщо в вашій роботі використовуються стандартні реалізації pop(), push(), append(), будь-які списки, стандартні або 3rd party бібліотеки зі структурами крім звичайного array, ви робите щось не так.
