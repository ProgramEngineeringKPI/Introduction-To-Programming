...
```
Скоріше за все вам знадобляться лише поля, позначені стрілкою. Зауважте, що в С/С++ немає типів даних int8, int16 тощо. Ці числа додані, щоб було однозначно зрозуміло, скільки біт займає кожне поле. Далі йде інформація про пікселі у вигляді масиву з таких структур:
```C
typedef struct {
     int8 redComponent;
     int8 greenComponent;
...
```
Зауважте, що в С/С++ немає типів даних int8, int16 тощо. Ці числа додані, щоб було однозначно зрозуміло, скільки біт займає кожне поле. 
